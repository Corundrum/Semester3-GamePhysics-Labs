...
glm::vec2 Util::Project(glm::vec2 vec, glm::vec2 projectedto)
{

	return Util::Dot(vec, projectedto) * projectedto;
}
...
glm::vec2 Util::AngleMagnitudeToVec2(float angle, float magnitude)
{
	return glm::vec2
	(
